...
function App() {
  ...
  return <>
    ...
    <main id="home">
      ...
      <section id="qualifications" className="section journey"><div className="container"><div className="row g-0 align-items-stretch"><div className="col-lg-5 journey-photo"><img src={doctorPhoto} alt="Dr. Sree Sai Rekha S"/></div><div className="col-lg-7 journey-copy"><p className="eyebrow">EDUCATION & EXPERIENCE</p><h2>A career built on<br/><em>precision and learning.</em></h2><div className="timeline">{qualifications.map(([year, title, institution]) => <div key={year}><span>{year}</span><p><b>{title}</b><small>{institution}</small></p></div>)}<div><span>2023</span><p><b>Assistant Professor & Consultant Plastic Surgeon</b><small>Osmania Medical College, Hyderabad - clinical services, teaching, and research.</small></p></div><div><span>2022-23</span><p><b>Senior Resident - Plastic Surgery</b><small>ESI Medical College, Sanathnagar, Hyderabad.</small></p></div></div></div></div></div></section>
