...
document.querySelector('.contact-details').insertAdjacentHTML('beforeend', `
  <a class="clinic-map" href="https://www.google.com/maps/search/?api=1&query=${mapsQuery}" target="_blank" rel="noopener" aria-label="Open Rekha Clinic location in Google Maps">
